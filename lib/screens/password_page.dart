...
class PasswordPage extends StatefulWidget {
  ...
  PasswordPage(String username){
    this.username = username;
  }

  @override
  _PasswordPageState createState() => _PasswordPageState(this.username);
}
...
class _PasswordPageState extends State<PasswordPage> {
  ...
  String username="";
  _PasswordPageState(String username){
    this.username=username;
  }
  ...
  _speakAtAppStart() async{
    await flutterTts.speak("say your password please");
  }
  ...
  _navigate() async{
    ...
    if(ref["password"].toString()==resultText){
      Navigator.push(
        context,
