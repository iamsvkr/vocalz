...
class _UsernamePageState extends State<UsernamePage> {
  ...
  _speakAtAppStart() async{
    await flutterTts.speak("Say the Username please");
  }
  ...
  _navigate() async{
    ...
    print(resultText);
    var ref = await Firestore.instance.collection("login").document("user").collection("moving").document(resultText).get();
    if(ref["id"].toString()==resultText){
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => PasswordPage(resultText)),
      );
    }else{
